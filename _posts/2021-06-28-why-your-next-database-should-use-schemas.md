...
Putting all your stuff inside `dbo` is mostly not your best option. Instead, go to [https://github.com/dadepretto/demo-sample-database] and take a look at my way of structuring databases using schemas to avoid this anti-pattern in your next project.
